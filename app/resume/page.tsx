    ...
    <div className="flex flex-col items-center h-screen justify-center">
      ...
      <div className="flex w-full max-w-4xl p-4">
        ...
        <div className="w-1/2 flex flex-col p-8 m-2">
          <h2 className="text-2xl font-bold mb-4 text-white text-center">Paste Job Description</h2>
          <textarea
            className="border border-gray-300 p-2 rounded w-full h-full resize-y shadow-md"
